  ...
  return (
    <>
      ...
      >
        ...
        <td className={`px-4 py-4 border ${opersSelect && opersSelect.size > 0 && "border-gray-300"}  ${showVideos && showVideos.id === item.id && 'font-bold'} flex justify-between items-center`}>
        ...
        <td className={`px-4 py-4 border ${opersSelect && opersSelect.size > 0 && "border-gray-300"} `}>{item.machine_name}</td> 
        <td
          onClick={() => handleSam(item, true)}
          className={`px-4 py-2 border ${opersSelect && opersSelect.size > 0 && "border-gray-300"}  cursor-pointer ${item.is_sam_minutes && "font-bold"}`}
        >
          {samTotalItem} 
        ...
        <td
          ...
          className={`px-4 py-4 border ${opersSelect && opersSelect.size > 0 && "border-gray-300"} cursor-pointer ${!item.is_sam_minutes && "font-bold"}`}
        >
          {sam_seg}
        </td>
        ...
        {opersSelect.size >= 1 && balancing && (
          <>
            <td className={`px-4 py-4 border ${opersSelect && opersSelect.size > 0 && "border-gray-300"}`}>
